...
namespace Shapper.Services.Faqs
{
    public interface IFaqService
    {
        ...
        Task<List<FaqResponseDto>> GetByStoreCodeAsync(string storeCode);

        Task<PagedResponseDto<FaqResponseDto>> GetPaginatedAsync(int page, int pageSize, int? storeId = null);

        Task<PagedResponseDto<FaqResponseDto>> GetPaginatedByStoreCodeAsync(int page, int pageSize, string? storeCode = null);
