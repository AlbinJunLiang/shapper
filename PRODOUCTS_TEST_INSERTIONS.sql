...
('Libros', 'Literatura, ciencia y tecnolog�a', 'https://images.unsplash.com/photo-1495446815901-a7297e633e8d?q=80&w=400'),
...
('Cosm�ticos', 'Labiales y cuidado facial', 'url_beauty', 3),   -- Categoria Belleza (ID 3)
('Ingenier�a', 'Libros t�cnicos y software', 'url_libros', 4),  -- Categoria Libros (ID 4)
...
('Minimal Chair', 'Silla de dise�o minimalista para oficina o hogar', 125, 16.25, 10, 0, 'Color blanco, madera', 'Active', 1),
('Gorra Nike', 'Gorra deportiva ajustable color negro', 455, 59.15, 25, 5, 'Material transpirable', 'Active', 2),
('Lip Gloss', 'Brillo labial de larga duraci�n Dior', 55, 7.15, 50, 0, 'Tono rosado natural', 'Active', 3),
('Salsa Lizano', 'La salsa original de Costa Rica 700ml', 65, 8.45, 100, 0, 'Botella grande', 'Active', 5),
('Libro Kleppman', 'Designing Data-Intensive Applications', 55, 0, 15, 10, 'Tapa dura, edici�n en espa�ol', 'Active', 4);